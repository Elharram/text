...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ ᎬᏞᎻᎪᎡᎷ ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ ᎬᏞᎻᎪᎡᎷ ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ ᎬᏞᎻᎪᎡᎷ ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua elharm⁦.lua')
end
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./elharm⁦.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S elharm⁦ -X kill
screen -S elharm⁦ ./elharm⁦
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Bandaa2/ᎬᏞᎻᎪᎡᎷ/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1409176813,1223908266}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'ولف'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "t.me/sourc_elharm")
...
local elharm⁦_Msg = ''  
if msgs < 100 then 
elharm⁦_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
elharm⁦_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
elharm⁦_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
elharm⁦_Msg = 'متفاعل' 
elseif msgs < 1200 then 
elharm⁦_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
elharm⁦_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
elharm⁦_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
elharm⁦_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
elharm⁦_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
elharm⁦_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
elharm⁦_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
elharm⁦_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
elharm⁦_Msg = 'رب التفاعل'  
end 
return elharm⁦_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝒔𝒐𝒖𝒓𝒄𝒆 ᎬᏞᎻᎪᎡᎷ")  
...
function plugin_elharm⁦(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.elharm⁦ and msg then
pre_msg = plugin.elharm⁦(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function Sourceelharm⁦(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,elharm⁦_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf elharm⁦.lua')
os.execute('wget https://raw.githubusercontent.com/Bandaa2/ᎬᏞᎻᎪᎡᎷ/main/elharm⁦.lua')
...
if text == 'الهرم مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV elharm⁦](@ELHARM_MAFIA)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ᎬᏞᎻᎪᎡᎷ', url="@ELHARM_MAFIA"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/sourc_elharm"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/elharm2900_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝗧𝘄𝗮𝘀𝗼𝗹𓆪', url="t.me/elharm2900_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,'⚪  عدد الجروبات الان » { '..#group..' }'..elharm⁦k..''..elharm⁦..'\n⚪  الان عدد الجروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ⚪ العضو » ['..result.title_..'](t.me/'..(username or 't.me/sourc_elharm')..')'
status  = '\n ⚪ تم ترقيته مطور'
...
usertext = '\n ⚪ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 't.me/sourc_elharm')..')'
status  = '\n ⚪ تم ترقيته مطور'
...
local elharm⁦1_Msg = database:get(bot_id.."elharm⁦1:Add:Filter:Rp2"..text..msg.chat_id_)   
if elharm⁦1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⚪ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 't.me/sourc_elharm')..') \n ⚪ '..elharm⁦1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if elharm⁦_Msg and not Special(msg) then  
local elharm⁦_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if elharm⁦_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⚪ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⚪ ["..elharm⁦_Msg.."] \n")
else
send(msg.chat_id_,0," ⚪ العضو : {["..data.first_name_.."](t.me/sourc_elharm)}\n ⚪ ["..elharm⁦_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⚪ عذرا » {["..data.first_name_.."](t.me/sourc_elharm)}\n ⚪ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."elharm⁦:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."elharm⁦:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."elharm⁦:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."elharm⁦:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."elharm⁦:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."elharm⁦:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."elharm⁦:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."elharm⁦:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."elharm⁦:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."elharm⁦:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."elharm⁦:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."elharm⁦:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."elharm⁦:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⚪ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "t.me/sourc_elharm")..")\n⚪ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."elharm⁦:teh"..msg.chat_id_).."} بجانب اسمك\n⚪ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local elharm⁦ChengName = database:get(bot_id.."elharm⁦:Cheng:Name"..data.id_)
if not data.first_name_ then 
if elharm⁦ChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..elharm⁦ChengName..']')
database:del(bot_id.."elharm⁦:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if elharm⁦ChengName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."elharm⁦:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local elharm⁦ChengUserName = database:get(bot_id.."elharm⁦:Cheng:UserName"..data.id_)
if not data.username_ then 
if elharm⁦ChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..elharm⁦ChengUserName..']')
database:del(bot_id.."elharm⁦:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if elharm⁦ChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."elharm⁦:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local elharm⁦ChengPhoto = database:get(bot_id.."elharm⁦:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if elharm⁦ChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."elharm⁦:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if elharm⁦ChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "غيرت صورتك يمكار🥂😹 ",
  "ها شو غيرت صورتك 🤔😹",
...
database:set(bot_id.."elharm⁦:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local Text = [[
️𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 ᎬᏞᎻᎪᎡᎷ♡ ️مرحبا بك في سورس ᎬᏞᎻᎪᎡᎷالاعظم
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩ᎬᏞᎻᎪᎡᎷ⁩𓆪',url="@ELHARM_MAFIA"}},
{{text = '𓆩ᏙΌᎠᏦᎪ𓆪',url="t.me/DV_Vo_Dk_A1"}},
{{text = '𓆩𝙨𝙤𝙪𝙧𝙘𝙚𓆪', url="t.me/sourc_elharm"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
W𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒕𝒉𝒆 ᎬᏞᎻᎪᎡᎷ♡️  مرحبا بك في سورس  ᎬᏞᎻᎪᎡᎷ
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩ᎬᏞᎻᎪᎡᎷ⁩𓆪',url="@ELHARM_MAFIA"}},
{{text = '𓆩ՏΌႮᎡᏟᎬ⁩𓆪',url="t.me/sourc_elharm"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'الصعيدي' or text == 'فودكا' or text == 'الهرم ' then
local Text = [[
DEV elharm⁦♡⁩
]]
keyboard = {} 
...
if text == 'قناه السورس ' or text == '@sourc_elharm' or text == 'متيجي' then
local Text = [[
اشترك بقناه السورس فضلا وليس امرا]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'قناه السورس يرحي',url="t.me/sourc_elharm"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس ᎬᏞᎻᎪᎡᎷ ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس ᎬᏞᎻᎪᎡᎷ ؟ ", 
"كم مره حبيت؟ ", 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ՏΌႮᎡᏟᎬ', url="t.me/sourc_elharm"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⚪ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 't.me/sourc_elharm')..') \n ⚪ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⚪ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 't.me/sourc_elharm')..') \n ⚪ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " 🕸️ لا يمكنك حظر المبرمج الهرم \n")
return false 
end
if result.sender_user_id_ == tonumber(1223908266) then
send(msg.chat_id_, msg.id_, " 🕸️ لا يمكنك حظر المبرمج فودكا \n")
return false 
end
...
function(arg,data) 
usertext = '\n 🕸️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 't.me/sourc_elharm')..')'
...
usertext = '\n 🕸️ العضو » ['..result.title_..'](t.me/'..(username or 't.me/sourc_elharm')..')'
status  = '\n 🕸️ تم حظره عام من الكروبات'
texts = usertext..status
...
if result.sender_user_id_ == tonumber(1409176813) then
send(msg.chat_id_, msg.id_, " 🕸️ لا يمكنك كتم المبرمج الهرم \n")
return false 
end
if result.sender_user_id_ == tonumber(1223908266) then
send(msg.chat_id_, msg.id_, " 🕸️ لا يمكنك كتم المبرمج فودكا \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Bandaa2/ᎬᏞᎻᎪᎡᎷ/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⚪ اهلا بك في متجر ملفات سون\n ⚪ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ ᎬᏞᎻᎪᎡᎷ ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ ᎬᏞᎻᎪᎡᎷ ┉  ┉ ┉ ┉ ┉≫ٴ\n ⚪ علامة تعني { ✔️ } ملف مفعل\n ⚪ علامة تعني { ✖ } ملف معطل\n ⚪ قناة سورس سون ↓\n".." ⚪ [اضغط هنا لدخول](t.me/sourc_elharm) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Bandaa2/ᎬᏞᎻᎪᎡᎷ/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "SRC-elharm⁦")
...
function Function_elharm⁦(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_elharm⁦, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_elharm⁦, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⚪ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 't.me/sourc_elharm')..')'
status  = '\n ⚪ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⚪ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⚪ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 't.me/sourc_elharm')..')'
...
' }\n'..' ⚪  الايدي بالصوره » { '..idph..
' }\n'..' ⚪  الرفع » { '..setadd..
' }\n'..' ⚪  الحظر » { '..banm..' }\n\nٴ≪┉ ┉ ┉ ┉ ┉ ᎬᏞᎻᎪᎡᎷ ┉  ┉ ┉ ┉ ┉≫ٴ\n ⚪ قناة سورس سون ↓\n [ 𝒔𝒐𝒖𝒓𝒄𝒆 ᎬᏞᎻᎪᎡᎷ](t.me/sourc_elharm) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
database:set(bot_id.."elharm⁦1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."elharm⁦1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ⚪ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."elharm⁦1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."elharm⁦1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."elharm⁦1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."elharm⁦1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ⚪ تم منع الكلمه مع التحذير")  
database:del(bot_id.."elharm⁦1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."elharm⁦1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."elharm⁦1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."elharm⁦1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ⚪ ارسل الكلمه الان")  
database:set(bot_id.."elharm⁦1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."elharm⁦1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."elharm⁦1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."elharm⁦1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."elharm⁦1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."elharm⁦1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."elharm⁦1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."elharm⁦1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."elharm⁦1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ⚪ قائمة المنع \nٴ≪┉ ┉ ┉ ┉ ┉ ᎬᏞᎻᎪᎡᎷ ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do  
local elharm⁦_Msg = database:get(bot_id.."elharm⁦1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..elharm⁦_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⚪ العضو » ['..result.title_..'](t.me/'..(text1[3] or 't.me/sourc_elharm')..')'..'\n ⚪ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..elharm⁦_Msg[math.random(#elharm⁦_Msg)]..']') 
return false
end
if text == "بوت" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سون')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:elharm⁦:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ⚪ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:elharm⁦:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:elharm⁦:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:elharm⁦:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:elharm⁦:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"⚪ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:elharm⁦:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:elharm⁦:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:elharm⁦:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:elharm⁦:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:elharm⁦:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:elharm⁦:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:elharm⁦:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:elharm⁦:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:elharm⁦:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:elharm⁦:List:Rd:Sudo")
end
...
database:set(bot_id.."t.me/sourc_elharm:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."t.me/sourc_elharm:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."t.me/sourc_elharm:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."t.me/sourc_elharm:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⚪تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."t.me/sourc_elharm:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."t.me/sourc_elharm:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
database:set(bot_id.."botss:elharm⁦:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:elharm⁦:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"⚪ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:elharm⁦:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:elharm⁦:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:elharm⁦:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:elharm⁦:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:elharm⁦:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:elharm⁦:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:elharm⁦:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:elharm⁦:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:elharm⁦:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:elharm⁦:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:elharm⁦:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:elharm⁦:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"⚪تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:elharm⁦:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:elharm⁦:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:elharm⁦:Add:Rd:Sudo:Text2"..text)   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 't.me/sourc_elharm')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
elharm⁦dx(msg.chat_id_, msg.id_, ' ⚪ ايدي المجموعة » ( '..msg.chat_id_..' )\n ⚪ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ⚪ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ⚪ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
{
{text = 'SOURCE ᎬᏞᎻᎪᎡᎷ', url="t.me/sourc_elharm"},
{text = 'مبرمج السورس', url="@ELHARM_MAFIA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ ᎬᏞᎻᎪᎡᎷ ┉  ┉ ┉ ┉ ┉≫ٴٴ\n⚪ [ 𝒔𝒐𝒖𝒓𝒄𝒆 ᎬᏞᎻᎪᎡᎷ ](t.me/sourc_elharm)')
end
...
if text == "مح" or text == "بوسه" or text == "بوسي" or text == "مصي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
elharm⁦ = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(elharm⁦)
...
--------------------------------------------------------------------------------------------------------------
Sourceelharm⁦(data.message_,data)
plugin_elharm⁦(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local elharm⁦Abot = database:get(bot_id.."elharm⁦1:Add:Filter:Rp2"..text..result.chat_id_)   
if elharm⁦Abot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⚪ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⚪ ["..elharm⁦Abot.."] \n") 
...
------------------------------------------------------------------------
if text then
local elharm⁦1_Msg = database:get(bot_id.."elharm⁦1:Add:Filter:Rp2"..text..result.chat_id_)   
if elharm⁦1_Msg then    
send(msg.chat_id_, msg.id_," ⚪ "..elharm⁦1_Msg)
